<nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-dark">
    <a class="navbar-brand" href="index.php" style="margin-left: 1%;"><?php echo $siteName ?></a>
    ...
    <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="index.php?page=afficher-varietes">Afficher les variétés</a>
            </li>
            <li class="nav-item">
