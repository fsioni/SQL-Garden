...
<br>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#detailsJardinModal" data-bs-id="-1" data-bs-name="Jardin" data-bs-surface="0">Ajouter un jardin</button>
<br>
<br>
<br>
                    ...
                    <td>
                        <ul class="list-inline m-0">
                            <li class="list-inline-item">
                                <a class="btn btn-danger" href='index.php?page=gestion-jardin&delete=<?php echo $jardin["idJ"] ?>'>Supprimer</a>
                            </li>
                            <li class="list-inline-item">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#detailsJardinModal" data-bs-id="<?php echo $jardin["idJ"] ?>" data-bs-name="<?php echo $jardin["nomJ"] ?>" data-bs-type="<?php echo $jardin["idTJ"] ?>" data-bs-surface="<?php echo $jardin["surface"] ?>">Modifier</button>
                            </li>
                            <?php if ($nbParc != 0) { ?>
                                <li class="list-inline-item">
                                    <a type="button" class="btn btn-info" href='index.php?page=afficher-parcelles&idJ=<?php echo $jardin["idJ"] ?>'>Afficher les parcelles</a>
                                </li>
                            <?php } ?>
                        </ul>
                    </td>
...
<div class="modal fade" id="detailsJardinModal" tabindex="-1" aria-labelledby="detailsJardinModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="#">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="jardin-surface" id="jardin-surface" type="number" min="0" max="5000" step="1" class="form-control" required>
                    </div>
                    <div class="mb-3">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="boutonValiderModifier" name="boutonValiderModifier" value="id" class="btn btn-success">Modifier le jardin</button>
                </form>
            </div>
        </div>
    </div>
